...
import { AddSiteDialogComponent } from '../add-site-dialog/add-site-dialog';
import { EditSiteDialogComponent } from '../edit-site-dialog/edit-site-dialog';
import { ConfirmDeleteDialogComponent } from '../confirm-delete-dialog/confirm-delete-dialog';
import { InputDialogComponent } from '../input-dialog/input-dialog';
import { LoginTutorialDialogComponent } from '../login-tutorial-dialog/login-tutorial-dialog';
import { ToastComponent } from '../toast/toast.component';
import { WelcomeDialogComponent } from '../welcome-dialog/welcome-dialog';
import { GoogleLoginUnsupportedDialogComponent } from '../google-login-unsupported-dialog/google-login-unsupported-dialog';
import { GrantPermissionDialogComponent } from '../grant-permission-dialog/grant-permission-dialog';
import { InstallExtensionDialogComponent } from '../install-extension-dialog/install-extension-dialog.component';
import { ThirdPartyCookiesBlockedDialogComponent } from '../third-party-cookies-blocked-dialog/third-party-cookies-blocked-dialog';
...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  private loadAdScript(): void {
    const scriptSrc = 'https://cdn.jsdelivr.net/gh/AMAARETS/ads@d9c43bb/share.js?v=' + new Date().getTime();
    //const scriptSrc = 'assets/script.js?v=' + new Date().getTime();
